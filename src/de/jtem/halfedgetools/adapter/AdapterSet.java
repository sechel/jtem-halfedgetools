...
import de.jtem.halfedgetools.adapter.generic.TextureBaryCenter2dAdapter;
import de.jtem.halfedgetools.adapter.generic.TextureBaryCenter3dAdapter;
import de.jtem.halfedgetools.adapter.generic.TextureBaryCenter4dAdapter;
import de.jtem.halfedgetools.adapter.generic.TextureBaryCenterAdapter;
...
public class AdapterSet extends TreeSet<Adapter<?>> {
	...
	public static AdapterSet createGenericAdapters() {
		...
		aSet.add(new BaryCenter2dAdapter());
		aSet.add(new BaryCenter3dAdapter());
		aSet.add(new BaryCenter4dAdapter());
		aSet.add(new TextureBaryCenterAdapter());
		aSet.add(new TextureBaryCenter2dAdapter());
		aSet.add(new TextureBaryCenter3dAdapter());
		aSet.add(new TextureBaryCenter4dAdapter());		
		aSet.add(new FaceAreaAdapter());
		aSet.add(new Position2dAdapter());
